...
namespace FannyNet {
  ...
  class FINNY_NET_API NetBuffer
    ...
    public:
      ...
      explicit NetBlockBase(SessionId s) :m_data(nullptr), m_state(_STATE_INIT_), m_session(s) { ; }
    ...
    public:
      ...
      explicit NetBlock(SessionId s, BufferPtr buffer, const DecryptEncryptFunType& encryptFun = nullptr);
