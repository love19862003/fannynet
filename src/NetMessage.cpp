/********************************************************************
  ...
  Organization:
*********************************************************************/
#ifndef __FANNY_NetMessage_H__
#define __FANNY_NetMessage_H__
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
#include "MyLog.h"
 namespace FannyNet {
    ...
    NetBlock::NetBlock(SessionId s, BufferPtr buffer, const DecryptEncryptFunType& encryptFun) :NetBlockBase(s) {
    ...
    NetBlock::NetBlock(SessionId s) : NetBlockBase(s){
      memset(&m_head, 0, sizeof(head));
    }
